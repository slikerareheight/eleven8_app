...
$pdo->prepare('INSERT INTO activity_logs(user_id,event_type,details,ip_address) VALUES(?,?,?,?)')
    ->execute([$user['id'],'login',json_encode(['email'=>$email]),$_SERVER['REMOTE_ADDR']??null]);
