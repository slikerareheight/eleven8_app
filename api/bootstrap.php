...
/*
 * This bootstrap is shared by both API endpoints and normal PHP pages.
 * Do not force application/json globally, otherwise pages such as
 * dashboard.php, login.php, signup.php and booking.php are served as
 * JSON/plain source instead of normal HTML.
 */
